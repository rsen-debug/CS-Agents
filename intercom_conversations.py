...
def summarize_ticket(conv_id, context: str):
    if not context.strip():
        return conv_id, {"pain_point": "No content available.", "action_taken": "", "sentiment": "Neutral"}
    try:
        resp = requests.post(
        ...
        return conv_id, parsed
    except Exception as e:
        return conv_id, {"pain_point": f"[Error: {e}]", "action_taken": "", "sentiment": "Neutral"}
